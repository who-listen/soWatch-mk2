...
exports.website = [
  [
    ...
    "youku.com",
    [
      ["player", 0, "loader.swf", /https?:\/\/static\.youku\.com(\/v[\d\.]*)?\/v\/swf\/.*\/loaders?\.swf/i],
      ["player", 0, "player.swf", /https?:\/\/static\.youku\.com(\/v[\d\.]*)?\/v\/swf\/.*\/q?player.*\.swf/i],
  ...
  [
    ...
    "tudou.com",
    [
      ["player", 0, "tudou.swf", /https?:\/\/static\.youku\.com(\/v[\d\.]*)?\/v\/custom\/.*\/q?player.*\.swf/i],
  ...
  [
    ...
    "iqiyi.com",
    [
      ["player", 0, "iqiyi5.swf", /https?:\/\/www\.iqiyi\.com\/(player\/\d+\/Player|common\/flashplayer\/\d+\/((Main)?Player_.*|[\d]{4}[a-z]+((?!aa).){6,7}))\.swf/i],
